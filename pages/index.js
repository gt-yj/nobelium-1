    ...
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
        ...
        <a
          ...
          className="underline"
        >Flowcode</a>{' '}I focus on fit and finish to solve problems and create seamless experiences with no-code tools like Bubble and Webflow.< br /> < br/> Apart from that, you can call me a comedian, a bookworm, a traveller, a philosopher, or a human who stares at a black screen 24/7.</p>
        <span className="h-8" />
      </div>
    </Container>
  )
